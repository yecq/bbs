...
// 	'install_locked'	=> Installez des verrouillages déjà installé, si vous êtes sûr de vouloir ré-installer, allez dans le serveur afin de supprimer<br /> '.str_replace(ROOT_PATH, '', $lockfile),//'安装锁定, 已经安装过了, 如果您确定要重新安装, 请到服务器上删除<br /> '.str_replace(ROOT_PATH, '', $lockfile),
