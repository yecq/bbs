...
var colortexts = {
	'Black'			: 'Czarny',//'黑色',
	'Sienna'		: 'Siena palona',//'赭色',
	'DarkOliveGreen'	: 'Ciemna zielona oliwa',//'暗橄榄绿色',
	'DarkGreen'		: 'Ciemna zieleń',//'暗绿色',
	'DarkSlateBlue'		: 'Ciemny szaroniebieski',//'暗灰蓝色',
	'Navy'			: 'Granatowy',//'海军色',
	'Indigo'		: 'Indygo',//'靛青色',
	'DarkSlateGray'		: 'Ciemna szara zieleń',//'墨绿色',
	'DarkRed'		: 'Ciemna czerwień',//'暗红色',
	'DarkOrange'		: 'Ciemny pomarańcz',//'暗桔黄色',
	'Olive'			: 'Oliwkowy',//'橄榄色',
	'Green'			: 'Zielony',//'绿色',
	'Teal'			: 'Morski',//'水鸭色',
	'Blue'			: 'Niebieski',//'蓝色',
	'SlateGray'		: 'Kamień',//'灰石色',
	'DimGray'		: 'Ciemny szary',//'暗灰色',
	'Red'			: 'Czerwony',//'红色',
	'SandyBrown'		: 'Brąz piaskowy',//'沙褐色',
	'YellowGreen'		: 'Żółtozielony',//'黄绿色',
	'SeaGreen'		: 'Zieleń morska',//'海绿色',
	'MediumTurquoise'	: 'Zielony szmaragd',//'间绿宝石',
	'RoyalBlue'		: 'Szafirowy',//'皇家蓝',
	'Purple'		: 'Purpurowy',//'紫色',
	'Gray'			: 'Szary',//'灰色',
	'Magenta'		: 'Magenta',//'红紫色',
	'Orange'		: 'Pomarańczowy',//'橙色',
	'Yellow'		: 'Żółty',//'黄色',
	'Lime'			: 'Kwaśny pomarańcz',//'酸橙色',
	'Cyan'			: 'Nienieskozielony',//'青色',
	'DeepSkyBlue'		: 'Błękitny',//'深天蓝色',
	'DarkOrchid'		: 'Ciemny purpurowy',//'暗紫色',
	'Silver'		: 'Srebrny',//'银色',
	'Pink'			: 'Różowy',//'粉色',
	'Wheat'			: 'Jasnożółty',//'浅黄色',
	'LemonChiffon'		: 'Cytrynowy',//'柠檬绸色',
	'PaleGreen'		: 'Jasno zielony',//'苍绿色',
	'PaleTurquoise'		: 'Blady turkus',//'苍宝石绿',
	'LightBlue'		: 'Jasnoniebieski',//'亮蓝色',
	'Plum'			: 'Śliwka',//'洋李色',
	'White'			: 'Biały' //'白色'
};
...
//static/js/editor_base.js
	'restore_last_saved'	: 'Czy na pewno chcesz przywrócić zapisaną zawartość?',//'您确定要恢复上次保存?',
	'cut_manually'		: 'Ustawienia Twojej przeglądarki nie pozwalają na automatyczne wykonanie operacji wycinania. Użyj skrótu klawiszowego (Ctrl X), aby zakończyć tę operację.',//'您的浏览器安全设置不允许编辑器自动执行剪切操作,请使用键盘快捷键(Ctrl+X)来完成',
	...
	'graffiti_no_init'	: 'Nie można odnaleźć danych dotyczących graffiti',//'找不到涂鸦板初始化数据',
	'ie5_only'		: 'Obsługa tylko dla IE 5.01 lub wyższej',//'只支持IE 5.01以上版本',
	'edit_raw'		: 'Edycja tekstu',//'编辑源码',
...
//static/image/admincp/cloud/cloud.js
	...
	'server_busy'		: 'Serwer jest zajęty. Proszę spróbować później.',//'服务器繁忙，请稍后再试',
	'tested_ok'		: 'Test został zakończony sukcesem. Czas trwania: ',//'测试成功，耗时 ',
	'seconds'		: ' sekund.',//' 秒',
...
//static/image/admincp/cloud/qqgroup.js
	...
	'wait_image_upload'	: 'Przesyłanie obrazka, proszę czekać...',//'图片上传中，请稍后...',
...
//static/js/common.js
	...
	'close'			: 'Zamknij',//'关闭',
	'wheel_zoom'		: 'Skorzystaj z rolki myszy, aby powiększyć lub oddalić ten obrazek.',//'鼠标滚轮缩放图片',
	...
	'flash_download'	: 'Pobierz wtyczkę Flash Player',//'下载 Flash Player',
	'day1'			: '1 dzień',//'一天',
	'week1'			: '1 tydzień',//'一周',
	'days7'			: '7 dni',//'7 天',
	'days14'		: '14 dni',//'14 天',
...
// The next line must have the same value as in /template.php - 'enter_content' !!!
	...
	'code_invalid'		: 'Wprowadzono błędny kod weryfikujący. Spróbuj ponownie.',//'验证码错误，请重新填写',
	...
	'notices_no'		: '[Brak]',//'【　　　】',
	'notices_yes'		: '[Nowe powiadomienia]',//'【新提醒】',
...
//	'wait_please'		: 'Wczytywanie ...',//'请稍候...',
	...
	'prev'			: 'Następna strona',//'上一张',
	'next'			: 'Wczytaj więcej zawartości',//'下一张',
...
//static/js/editor.js
	...
	'auto_play'		: 'Odtwarzać automatycznie?',//'是否自动播放',
	'flash_url'		: 'Wprowadź adres URL do pliku flash',//'请输入 Flash 文件地址',
	'enter_please'		: 'Proszę wprowadzić',//'请输入第',
	'nth_parameter'		: 'parameter -th',//' 个参数',
	'font'			: 'Czcionka',//'字体',
	'full_screen'		: 'Pełny ekran',//'全屏',
	'restore_size'		: 'Przywróć rozmiar',//'恢复',
	'general'		: 'Tryb ogólny',//'常用',
	'simple'		: 'Tryb rozszerzony',//'高级',
	'bad_browser'		: 'Twoja przeglądarka nie obsługuje żądanej funkcji',//'你的浏览器不支持此功能',
	...
	'enter_item_list'	: 'Proszę wprowadzić listę.\r\nPozostaw puste lub kliknij anuluj.',//'输入一个列表项目.\r\n留空或者点击取消完成此列表.',
	'width'			: 'Szerokość',//'宽',
	'height'		: 'Wysokość',//'高',
	...
	'expire_days'		: 'Ważne przez (dni)',//'有效天数',
	...
	'jump_tip_pid'		: 'ID tematu i posta',//'帖子的 TID 和 PID',
	'add_indent'		: 'Wcięcie pierwszej lini',//'添加行首缩进',
	'enter_post_password'	: 'Proszę wprowadzić hasło',//'请输入帖子密码',
...
//static/js/forum.js
	...
	'del_thread_sure'	: 'Czy na pewno chcesz usunąć ten temat z listy gorących?',//'您确认要把此主题从热点主题中移除么？',
...
//static/js/forum_post.js
	...
	'internal_error'	: 'Wewnętrzny błąd serwera',//'内部服务器错误',
	...
	'no_data_recover'	: 'Nie odnaleziono treści, które mogłyby zostać przywrócone!',//'没有可以恢复的数据！',
...
//	'upload_failed'		: 'Wysyłanie nie powiodło się.',//'上传失败',
	...
	'attach_big'		: 'Przekroczono dopuszczalny rozmiar załącznika',//'服务器限制无法上传那么大的附件',
	'attach_group_big'	: 'Grupa użytkownika, do której należysz nie zezwala na wysyłanie tak dużych plików',//'用户组限制无法上传那么大的附件',
	'attach_type_big'	: 'Grupa użytkownika, do której należysz nie zezwala na wysyłanie tego typu plików',//'文件类型限制无法上传那么大的附件',
	'attach_daily_big'	: 'Dzienny limit wysyłania załączników został wyczerpany',//'本日已无法上传更多的附件',
	'validating_q&a'	: 'Weryfikacja Q & A, proszę czekać',//'验证问答校验中，请稍后',
	'validating_code'	: 'Weryfikacja kodu, proszę czekać',//'验证码校验中，请稍后',
	'attach_type_disabled'	: 'To forum nie zezwala na wysyłanie tego typu plików',//'附件类型被禁止',
	'attach_max'		: 'Nie większy niż',//'不能超过',
	'vote_max_reached'	: 'Przekroczono maksymalną liczbę głosów: ',//'已达到最大投票数',
	'no_remote_attach'	: 'Przepraszamy, zdalne załączniki zostały wyłączone',//'抱歉，暂无远程附件',
...
//static/js/forum_viewthread.js
	...
	'credit_confirm1'	: 'Koszty pobierania wynoszą ',//'下载需要消耗',
	'credit_confirm2'	: ' punktów. Czy na pewno chcesz pobrać dane?',//'，您是否要下载？',
	'thread_to_clipboard'	: 'Adres tematu został skopiowany do schowka.',//'帖子地址已经复制到剪贴板',
	'click_to_enlarge'	: 'Kliknij tutaj, aby powiększyć',//'点击放大',
	...
	'qq_bind'		: 'Proszę połączyć się z kontem QQ',//'请先绑定QQ账号',
	'quote_by'		: 'Cytat .*? w .*? code',//'本帖最后由 .*? 于 .*? 编辑',
	'copy_code'		: 'Kopiuj kod',//'复制代码',
	'download_pocket_forum'	: 'Pobierz wersję kieszonkową forum',//'下载掌上论坛',
	'pocket_forum_android'	: 'Jeśli używasz systemu Andriod, przeskanuj kod QR. Aplikacja automatycznie zostanie pobrana na telefon.',//'Andriod版本，扫描二维码可以直接下载到手机',
	'pocket_forum_android_alt'	: 'Wspierane dla telefonów działających pod kontrolą systemu Android, jak Samsung/HTC/etc.',//'适用于装有安卓系统的三星/HTC/小米等手机',
	'pocket_forum_ios'	: 'Jeśli używasz marki iPhone, przeskanuj kod QR. Aplikacja automatycznie zostanei pobrana na telefon.',//'iPhone版本，扫描二维码可以直接下载到手机',
	'pocket_forum_ios_alt'	: 'Wspierane dla telefonów Apple.',//'适用于苹果手机',
...
//static/js/handlers.js
	...
	'file_is_large'		: 'Ten plik jest za duży.',//'文件太大.',
...
//static/js/home_common.js
	...
	'show_orig_image'	: 'Pokaż obrazek w nowym oknie',//'点击图片，在新窗口显示原始尺寸',
	'continue_sure'		: 'Czy na pewno chcesz kontynuować?',//'您确定要执行本操作吗？',
	'select_item'		: 'Proszę wybrać obiekt',//'请选择要操作的对象',
	'image_url_invalid'	: 'Błędny adres URL zdjęcia',//'图片地址不正确',
	'audio_url_invalid'	: 'Błędny adres URL audio. To pole nie może być puste.',//'音乐地址错误，不能为空',
...
//static/js/home_uploadpic.js
	...
	'image_type_invalid'	: 'Przepraszamy, rozszerzenie podanego obrazka nie jest wspierane.',//'对不起，不支持上传此类扩展名的图片',
	'insert_to_content'	: 'Kliknij tutaj, aby wprowadzić zawartość do aktualnej pozycji kursora.',//'点击这里插入内容中当前光标的位置',
	'insert'		: 'Wprowadź',//'插入',
...
//static/js/portal.js
	...
	'blocks_found1'		: 'Odnaleziono',//'找到',
	'blocks_found2'		: 'zgodnych bloków',//'个相应的模块',
	'blocks_not_found'	: 'Brak zgodnych bloków',//'没有相应的模块',
	...
	'block_convert_sure'	: 'Czy na pewno chcesz dokonać konwersji bloku z',//'你确定要转换模块的类型从',
	'back'			: 'Powrót',//'返回',
	...
	'tags_not_match'	: ' - tagi nie istnieją',//' 标签不匹配',
	'entered'		: 'Wprowadzonych ',//'已输入 ',
	'exceed'		: 'Exceed ',//'超出 ',
...
//static/js/portal_diy.js
	...
	'size'			: 'Rozmiar',//'大小',
	'color'			: 'Kolor',//'颜色',
	'separate_config'	: 'Oddzielna konfiguracja',//'分别设置',
	'right'			: 'Prawo',//'右',
	'bottom'		: 'Dół',//'下',
	'top'			: 'Góra',//'上',
	'left'			: 'Lewo',//'左',
	...
	'block'			: 'Blok',//'模块',
	'frame'			: 'Okno',//'框架',
	'onclick'		: 'po kliknięciu',//'点击',
	'onmouseover'		: 'po najechaniu myszą',//'滑过',
...
//	'colour'		: 'Colour',//'色',
	...
	'clear_diy_sure'	: 'Czy na pewno chcesz usunąć wszystkie dane z aktualnej strony DIY? Ta operacja jest nieodwracalna.',//'您确实要清空页面上所在DIY数据吗,清空以后将不可恢复',
...
//static/js/portal_diy_data.js
	'data_manage'		: 'Zarządzanie danymi bloków',//'可直接管理模块数据',
	'quit'			: 'Wyjście',//'退出',
//--------------------------------
//static/js/qshare.js
	'from_tencent'		: 'Wysłano z otwartej platformy mikroblogowej Tencent',//"\u6211\u6765\u81EA\u4E8E\u817E\u8BAF\u5FAE\u535A\u5F00\u653E\u5E73\u53F0",

//--------------------------------
//static/js/register.js

	'username_invalid'	: 'Nazwa użytkownika zawiera niedozwolone znaki',//'用户名包含敏感字符',
	'username_short'	: 'Minimalnie 2 znaki',//'用户名小于 3 个字符',
	'username_long'		: 'Do 15 znaków',//'用户名超过 15 个字符',
...
//static/js/threadsort.js
	...
	'value_is_greater'	: 'Wartość przekroczyła limit',//'大于设置最大值',
	'value_is_less'		: 'Wartość jest mniejsza od minimalnej',//'小于设置最小值',
	'enter_valid_url'	: 'Proszę wprowadzić poprawny adres URL, rozpoczynający się od http://',//'请正确填写以http://开头的URL地址',
...
//source/function/function_admincp.php
	'version_uptodate'	: 'Aktualnie używasz najświeższej wersji programu Discuz!. Proszę odnieść się do następujących wskazówek, aby mieć możliwość informowania o najnowszych aktualizacjach.',

//-------------------------------------
//api/manyou/cloud_iframe.js
	'add_operation'		: 'Dodaj do wspólnych operacji',//'&#28155;&#21152;&#21040;&#24120;&#29992;&#25805;&#20316;',

//--------------------------------------------
//static/js/googlemap.js + static/js/editor.js

	'map_title'		: 'Mapy Google',//'google图',
	'map_insert'		: 'Wprowadź lokalizację dzięki usłudze Google Maps',//'插入google地图',
	'map_insert_tips'	: 'Wprowadź lokalizację dzięki usłudze Google Maps (tymczasowo wspieramy tylko jedną etykietę)',//'通过搜索插入google地图（暂只支持单点标注）！',
	'map_center_changed'	: 'Mapa uległa zmianie!',//'地图中心已经改变！',
