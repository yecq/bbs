...
(
	...
	'never_expired'		=> 'Nigdy nie wygaśnie',//'永不过期',
	'sort_update'		=> 'Aktualizuj',//'更新',
	'sort_upload'		=> 'Wyślij',//'上传',
	...
	'post_trade_transport_type'	=> 'Typ transportu',//'物流方式',
	...
	'post_trade_transport_express'	=> 'Ekspresowa',//'快递',
	'post_trade_transport_virtual'	=> 'Wirtualna',//'虚拟物品或无需邮递',
...
//vot	'post_trade_locus'		=> 'Lokalizacja',//'所在地点',
	...
	'post_trade_pm_subject'		=> '[Okazja]',//'[议价]',
	'post_trade_pm_buynum'		=> 'Kup',//'购买数量',
	'post_trade_pm_wishprice'	=> 'Propozycja ceny',//'我期望的价格是',
	...
	'attach_credits_policy'		=> 'Pokaż zasady płatności',//'查看积分策略说明',
	'attach_img'			=> 'Dodaj obrazek',//'图片附件',
	'attach_readperm'		=> 'Zezwolenia',//'阅读权限',
	'attach_img_zoom'		=> 'Kliknij tutaj, aby wyświetlić obrazek w nowym oknie.\\nCTRL + rolka myszy zwiększa lub zmniejsza rozmiary obrazka.',//'点击在新窗口查看全图\\nCTRL+鼠标滚轮放大或缩小',
	'attach_img_thumb'		=> 'Kliknij tutaj, aby wyświetlić obrazek w nowym oknie.',//'点击在新窗口查看全图',
	'attach_downloads'		=> 'Liczba pobrań',//'下载次数',

	'post_trade_transport'		=> 'Opłata za transport',//'邮费',
//vot	'post_trade_transport_mail'	=> 'Ekonomiczna',//'平邮',
	'post_trade_quality'		=> 'Typ produktu',//'商品成色',
	'post_trade_quality_new'	=> 'Nowe',//'全新',
	'post_trade_quality_secondhand'	=> 'Używane',//'二手',

	'trade_unstart'			=> '<font color="gray">Trwa przetwarzanie</font>',//'<font color="gray">未生效的交易</font>',
	'trade_waitbuyerpay'		=> 'Oczekiwanie na wpłatę kupującego',//'等待买家付款',
	'trade_waitsellerconfirm'	=> 'Oczekiwanie na potwierdzenie sprzedaży',//'交易已创建，等待卖家确认',
	'trade_sysconfirmpay'		=> 'Oczekiwanie na potwierdzenie wpłaty',//'确认买家付款中，暂勿发货',
	...
	'trade_syspayseller'		=> 'Dostarczono. Oczekiwanie na dostarczenie wpłaty.',//'买家确认收到货，等待支付宝打款给卖家',
	...
	'trade_waitalipayrefund'	=> 'Obie strony wyraziły zgodę na zwrot towaru. Proszę czekać na zwrot kwoty.',//'双方已经一致，等待支付宝退款',
	'trade_alipaycheck'		=> 'Oczekiwanie na system płatności.',//'支付宝处理中',
	'trade_overedrefund'		=> 'Zwrot',//'结束的退款',
	...
	'trade_offline_1'		=> 'Transakcja w toku',//'交易单生效',
	...
	'trade_message_4'		=> 'Proszę wybrać metodę płatności.',//'可输入付款方式、银行账号等信息',
	'trade_message_5'		=> 'Proszę wprowadzić stosowne informacje.',//'可输入发货公司、发货单号等信息',
	'trade_message_13'		=> 'Proszę wprowadzić stosowne informacje.',//'可输入发货公司、发货单号等信息',

	'credit_payment'		=> 'Doładuj punkty',//'积分充值',
	'credit_forum_payment'		=> 'Doładuj punkty forum',//'论坛积分充值',
	...
	'invite_forum_payment_unit'	=> 'jednostka płatnicza',//'个',
	...
	'formulaperm_buyercredit'	=> 'Ocena kupującego',//'买家信用评价',
	'formulaperm_sellercredit'	=> 'Ocena sprzedającego',//'卖家信用评价',
	...
	'eccredit_explain'		=> 'Wyjaśnienie',//'解释',
	...
	'notice_actor'		=> 'Łącznie: $actorcount osób',//'等 $actorcount 人',
	...
	'perms_allownickname'		=> 'Pozwól na użycie nicku',//'使用昵称',
	...
	'perms_maxbiosize'		=> 'Maksymalna długość znaków w polu "o mnie"',//'自我介绍最大长度',
	'perms_allowrecommend'		=> 'Polecanie tematów',//'主题评价影响值',
	'perms_allowbiobbcode'		=> 'Użycie BBCode w polu "o mnie"',//'自我介绍中使用编辑器代码',
	'perms_allowbioimgcode'		=> 'Użycie tagu [img] w polu "o mnie"',//'自我介绍中使用 [img] 代码',
...
//vot	'perms_allowbioimgcode'		=> 'Use [img] tag in self-about',//'自我介绍中使用 [img] 代码',
	...
	'perms_allowmassprune'		=> 'Masowanie usuwanie postów',//'批量删帖',
	...
	'seccode'		=> 'Weryfikacja',//'验证码',
	'seccode_update'	=> 'Odśwież',//'换一个',
	'seccode_player'	=> '<span style="padding:2px"><img border="0" style="vertical-align:middle" src="static/image/common/seccodeplayer.gif" /> <a href="javascript:;" onclick="window.document.seccodeplayer_{idhash}.SetVariable(\'isPlay\', 1)">Odsłuchaj kod weryfikacyjny</a></span>',//'<span style="padding:2px"><img border="0" style="vertical-align:middle" src="static/image/common/seccodeplayer.gif" /> <a href="javascript:;" onclick="window.document.seccodeplayer_{idhash}.SetVariable(\'isPlay\', 1)">播放验证码</a></span>',
	'secqaa'		=> 'Pytanie zabezpieczające',//'验证问答',

	'mobileoem_creditrule'	=> 'Mobilna rejestracja',//'掌上论坛签到',

// Added by Valery Votintsev, codersclub.org
	'poll_reply_no_perms'	=> 'Nie możesz odpowiadać w tej ankiecie',//'您不能对自己的回帖进行投票',
	'poll_replyed_already'	=> 'Odpowiedziałeś już w tej ankiecie',//'您已经对此回帖投过票了',
	'poll_voted_ok'		=> 'Głos został oddany',//'投票成功',
);
