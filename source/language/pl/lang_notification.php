...
(
	...
	'pic_comment_reply'	=> '{actor} odpowiedział na Twój <a href="{url}" target="_blank">komentarz pod obrazkiem</a>.',//'{actor} 回复了你的 <a href="{url}" target="_blank">图片评论</a>',
	...
	'pic_comment'		=> '{actor} dodał komentarz pod <a href="{url}" target="_blank">obrazkiem</a>.',//'{actor} 评论了你的 <a href="{url}" target="_blank">图片</a>',
	...
	'click_pic'		=> '{actor} ocenił Twoje <a href="{url}" target="_blank">obrazek</a>.',//'{actor} 对你的 <a href="{url}" target="_blank">图片</a> 做了表态',
	...
	'activity_apply'	=> 'Organizator "{actor}" zaakceptował Twój udział w wydarzeniu <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a>. &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">Pokaż</a> <div class="quote"><blockquote>{reason}</blockquote></div>',//'活动 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 的发起人 {actor} 已批准你参加此活动 &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">查看 &rsaquo;</a> <div class="quote"><blockquote>{reason}</blockquote></div>',
	...
	'activity_delete'	=> 'Organizator "{actor}" odrzucił Twoją prośbę o udział w wydarzeniu <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a>. &nbsp; <a href="forum.php?mod=viewthread&tid={tid}"  target="_blank" class="lit">Pokaż</a> <div class="quote"><blockquote>{reason}</blockquote></div>',

	'activity_cancel'	=> '{actor} odrzucił Twój udział w wydarzeniu <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a>. &nbsp; <a href="forum.php?mod=viewthread&tid={tid}"  target="_blank" class="lit">View &rsaquo;</a> <div class="quote"><blockquote>{reason}</blockquote></div>',

	'activity_notification'	=> 'Wydarzenie <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> organizatora {actor} ogłasza, co następuje: &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit"> &rsaquo;</a> <div class="quote"><blockquote>{msg}</blockquote></div>',
	...
	'reward_bestanswer_moderator'	=> 'Twoja odpowiedź w temacie <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> została oznaczona jako najlepsza. &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">Pokaż &rsaquo;</a>',//'您在悬赏主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 的回复被选为最佳答案 &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">查看 &rsaquo;</a>',
	...
	'task_reward_magic'	=> 'Gratulację! Ukończyłeś następujące zadanie: <a href="home.php?mod=task&do=view&id={taskid}" target="_blank">{name}</a>, otrzymując magię {bonus} <a href="home.php?mod=magic&action=mybox" target="_blank">{rewardtext}</a>',//'恭喜你完成任务：<a href="home.php?mod=task&do=view&id={taskid}" target="_blank">{name}</a>，获得道具 <a href="home.php?mod=magic&action=mybox" target="_blank">{rewardtext}</a> {bonus} 张',

	'task_reward_medal'	=> 'Gratulację! Ukończyłeś następujące zadanie: <a href="home.php?mod=task&do=view&id={taskid}" target="_blank">{name}</a>, otrzymując medal <a href="forum.php?mod=medal" target="_blank">{rewardtext}</a>. Ważność medalu to {bonus} dni.',//'恭喜你完成任务：<a href="home.php?mod=task&do=view&id={taskid}" target="_blank">{name}</a>，获得勋章 <a href="forum.php?mod=medal" target="_blank">{rewardtext}</a> 有效期 {bonus} 天',

	'task_reward_medal_forever'	=> 'Gratulację! Ukończyłeś następujące zadanie: <a href="home.php?mod=task&do=view&id={taskid}" target="_blank">{name}</a>, otrzymując medal <a href="home.php?mod=medal" target="_blank">{rewardtext}</a>.',//'恭喜您完成任务：<a href="home.php?mod=task&do=view&id={taskid}" target="_blank">{name}</a>，获得勋章 <a href="home.php?mod=medal" target="_blank">{rewardtext}</a> 永久有效',

	'task_reward_invite'	=> 'Gratulację! Ukończyłeś następujące zadanie: <a href="home.php?mod=task&do=view&id={taskid}" target="_blank">{name}</a>. W nagrodę otrzymałeś <a href="home.php?mod=spacecp&ac=invite" target="_blank">kod zaproszenia {rewardtext}</a> ważny na {bonus} dni.',

	'task_reward_group'	=> 'Gratulację! Ukończyłeś następujące zadanie:: <a href="home.php?mod=task&do=view&id={taskid}" target="_blank">{name}</a>, otrzymując awans do grupy {rewardtext}. Ważność na kolejne {bonus} dni. &nbsp; <a href="home.php?mod=spacecp&ac=usergroup" target="_blank" class="lit">View my permissions</a>',//'恭喜你完成任务：<a href="home.php?mod=task&do=view&id={taskid}" target="_blank">{name}</a>，获得用户组 {rewardtext} 有效期 {bonus} 天 &nbsp; <a href="home.php?mod=spacecp&ac=credit&op=usergroup" target="_blank" class="lit">看看我能做什么 &rsaquo;</a>',
	...
	'grouplevel_update'	=> 'Gratulację! Poziom Twojej grupy {groupname} otrzymał awans do {newlevel}.',//'恭喜你，你的群组 {groupname} 已经升级到了 {newlevel}。',

	'thread_invite'		=> '{actor} zaprasza: {invitename} <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a>. &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">Pokaż</a>',//'{actor} 邀请你{invitename} <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">查看 &rsaquo;</a>',
	...
	'article_invite'	=> '{actor} zaprosił Cię do przeczytania artykułu <a href="portal.php?mod=view&aid={aid}" target="_blank">{subject}</a>, &nbsp; <a href="portal.php?mod=view&aid={aid}" target="_blank" class="lit">Pokaż &rsaquo;</a>',//'{actor} 邀请您查看文章 <a href="portal.php?mod=view&aid={aid}" target="_blank">{subject}</a> &nbsp; <a href="portal.php?mod=view&aid={aid}" target="_blank" class="lit">查看 &rsaquo;</a>',
	...
	'member_moderate_invalidate'	=> 'Aktywacja Twojego konta została odrzucona przez Administratora. Proszę <a href="home.php?mod=spacecp&ac=profile">ponowić proces rejestracyjny</a>.<br />Uwagi Administratora: <b>{remark}</b>',//'你的账号未能通过管理员的审核，请<a href="home.php?mod=spacecp&ac=profile">重新提交注册信息</a>。<br />管理员留言: <b>{remark}</b>',
	'member_moderate_validate'	=> 'Twoje konto zostało aktywowane.<br />Uwagi Administratora: <b>{remark}</b>',//'你的账号已经通过审核。<br />管理员留言: <b>{remark}</b>',
	'member_moderate_invalidate_no_remark'	=> 'Aktywacja Twojego konta została odrzucona przez Administratora. Proszę <a href="home.php?mod=spacecp&ac=profile">ponowić proces rejestracyjny</a>.',//'你的账号未能通过管理员的审核，请<a href="home.php?mod=spacecp&ac=profile">重新提交注册信息</a>。',
	'member_moderate_validate_no_remark'	=> 'Twoje konto zostało aktywowane.',//'你的账号已经通过审核。',
	'manage_verifythread'		=> 'Pojawiły się nowe oczekujące tematy. <a href="admin.php?action=moderate&operation=threads&dateline=all">Weryfikuj</a>',//'有新的待审核主题。<a href="admin.php?action=moderate&operation=threads&dateline=all">现在进行审核</a>',//'有新的待审核主题。<a href="admin.php?action=moderate&operation=threads&dateline=all">现在进行审核</a>',//'有新的待审核主题。<a href="admin.php?action=moderate&operation=threads&dateline=all">现在进行审核</a>',
	'manage_verifypost'		=> 'Pojawiły się nowe oczekujące odpowiedzi. <a href="admin.php?action=moderate&operation=replies&dateline=all">Weryfikuj</a>',//'有新的待审核回帖。<a href="admin.php?action=moderate&operation=replies&dateline=all">现在进行审核</a>',
	'manage_verifyuser'		=> 'Pojawili się nowi oczekujący użtytkownicy. <a href="admin.php?action=moderate&operation=members">Weryfikuj</a>',//'有新的待审核会员。<a href="admin.php?action=moderate&operation=members">现在进行审核</a>',
	'manage_verifyblog'		=> 'Pojawiły się nowe oczekujące wpisy na blogach. <a href="admin.php?action=moderate&operation=blogs">Weryfikuj</a>',//'有新的待审核日志。<a href="admin.php?action=moderate&operation=blogs">现在进行审核</a>',
	'manage_verifydoing'		=> 'Pojawiły się nowe oczekujące statusy. <a href="admin.php?action=moderate&operation=doings">Weryfikuj</a>',//'有新的待审核记录。<a href="admin.php?action=moderate&operation=doings">现在进行审核</a>',
	'manage_verifypic'		=> 'Pojawiły się nowe oczekujące obrazki. <a href="admin.php?action=moderate&operation=pictures">Weryfikuj</a>',//'有新的待审核图片。<a href="admin.php?action=moderate&operation=pictures">现在进行审核</a>',
	'manage_verifyshare'		=> 'Pojawiły się nowe oczekujące udostępnienia. <a href="admin.php?action=moderate&operation=shares">Weryfikuj</a>',//'有新的待审核分享。<a href="admin.php?action=moderate&operation=shares">现在进行审核</a>',
	'manage_verifycommontes'	=> 'Pojawiły się nowe oczekujące komentarze. <a href="admin.php?action=moderate&operation=comments">Weryfikuj</a>',//'有新的待审核留言/评论。<a href="admin.php?action=moderate&operation=comments">现在进行审核</a>',
	'manage_verifyrecycle'		=> 'Nowy temat został przeniesiony do kosza. <a href="admin.php?action=recyclebin">Weryfikuj</a>',//'回收站有新的待处理主题。<a href="admin.php?action=recyclebin">现在处理</a>',
	'manage_verifyrecyclepost'	=> 'Nowe odpowiedzi zostały przeniesione do kosza. <a href="admin.php?action=recyclebinpost">Weryfikuj</a>',//'回帖回收站有新的待处理回帖。<a href="admin.php?action=recyclebinpost">现在处理</a>',
	'manage_verifyarticle'		=> 'Pojawiły się nowe oczekujące artykuły. <a href="admin.php?action=moderate&operation=articles">Weryfikuj</a>',//'有新的待审核文章。<a href="admin.php?action=moderate&operation=articles">现在进行审核</a>',
	'manage_verifymedal'		=> 'Pojawiły się nowe oczekujące medale. <a href="admin.php?action=medals&operation=mod">Weryfikuj</a>',//'有新的待审核勋章申请。<a href="admin.php?action=medals&operation=mod">现在进行审核</a>',
	'manage_verifyacommont'		=> 'Pojawiły się nowe oczekujące komentarze do artykułów. <a href="admin.php?action=moderate&operation=articlecomments">Weryfikuj</a>',//'有新的待审核文章评论。<a href="admin.php?action=moderate&operation=articlecomments">现在进行审核</a>',
	'manage_verifytopiccommont'	=> 'Pojawiły się nowe oczekujące komentarze w tematach. <a href="admin.php?action=moderate&operation=topiccomments">Weryfikuj</a>',//'有新的待审核专题评论。<a href="admin.php?action=moderate&operation=topiccomments">现在进行审核</a>',
	'manage_verify_field'		=> 'Pojawiły się nowe oczekujące pola {verifyname}. <a href="admin.php?action=verify&operation=verify&do={doid}">Weryfikuj</a>',//'有新的待处理{verifyname}。<a href="admin.php?action=verify&operation=verify&do={doid}">现在处理</a>',
	'system_notice'			=> '{subject} <p class="summary">{message}</p>',
	'system_adv_expiration'		=> 'Ważność następujących reklam wygaśnie za {day} dni. Prosimy o kontakt z:<br />{advs}',//'您站点的以下广告将于 {day} 天后到期，请及时处理：<br />{advs}',
	...
	'collection_removed'		=> 'Twój udział w kolekcji <a href="forum.php?mod=collection&action=view&ctid={ctid}">{collectionname}</a> został anulowany przez {actor}.',//'您参与维护的淘专辑  <a href="forum.php?mod=collection&action=view&ctid={ctid}">{collectionname}</a> 已被 {actor} 关闭。',
	...
	'thread_hidden'		=> 'Twój temat <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> otrzymał zbyt wiele zgłoszeń jako niechciany SPAM i został ukryty. &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">View &rsaquo;</a>',//'您的主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 被多个用户认定为垃圾帖，现已被隐藏 &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">查看 &rsaquo;</a>',
