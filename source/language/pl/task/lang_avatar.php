 ...
 *
 *      $ID: lang_avatar.php by Valery Votintsev at 
...
(
	...
	'avatar_view'	=> '<strong>Poniższe kroki pomogą Ci ukończyć to zadanie:</strong>
		<ul>
		<li>1. <a href="home.php?mod=spacecp&ac=avatar" target="_blank">Otwórz stronę personalizacji awatarem</a>;</li>
		<li>2. Wybierz i wyślij nowy awatar</li>
		</ul>',
);
