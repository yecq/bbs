...
$lang = array (
	...
	'login_seccheck2'		=> 'Aby kontynuować, proszę wprowadzić kod weryfikacyjny',//'请输入验证码后继续登录',
	...
	'register_buyinvitecode'	=> 'Kliknij tutaj, aby otrzymać kod zaproszenia.',//'还没有邀请码？点击此处获取',
	'register_email_tips'		=> 'Proszę wprowadzić aktywny adres Email',//'请输入正确的邮箱地址',
	'register_message'		=> 'Powód rejestracji',//'注册原因',
	'register_message1'		=> 'Zdecydowałeś się więc na rejestrację w naszym serwisie. Dlaczego? Proszę wypełnić poprawnie wszystkie pola rejestracji. Wszystkie dane zostaną poddane weryfikacji.',//'你填写的注册原因会被当作申请注册的重要参考依据，请认真填写。',
	...
	'register_validate_email_tips'	=> 'Na samym początku rejestracja wymagać będzie potwierdzenia adresu e-mail. Proszę upewnić się, że wprowadzony adres jest poprawny i aktualny, ponieważ to właśnie tam otrzymasz dalsze instrukcje. <br />Wiadomość powinna zostać dostarczona w ciągu najbliższych kilku minut. W przeciwnym razie, proszę sprawdzić folder SPAM.',//'注册需要验证邮箱，请务必填写正确的邮箱，提交后请及时查收邮件。<br />您可能需要等待几分钟才能收到邮件，如果收件箱没有，请检查一下垃圾邮件箱。',
