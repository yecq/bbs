...
/*vot*/	'blockdata'		=> array(
	...
	'pm_export_header'	=> 'Nagrywanie prywatnych wiadomości Discuz! X (wiadomości zostaną zapisane w postaci zwykłego tekstu, the re-import nie jest wspierany)',//'Discuz! X 短消息记录(此消息记录为文本格式，不支持重新导入)',
	'pm_export_touser'	=> 'Odbiorcy: {touser}',//'消息对象: {touser}',
	'pm_export_subject'	=> 'Temat grupy: {subject}',//'群聊话题: {subject}',
	'all'			=> 'Wszystko',//'全部',
