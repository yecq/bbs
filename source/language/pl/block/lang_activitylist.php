...
(
	...
	'activitylist_titlelength_comment'	=> 'Wybierz maksymalną długość tytułu. Tytuł zostanie automatycznie skrócony, kiedy przekroczy dopuszczalny limit znaków. 0 wyłącza opcję.',//'设置当标题长度超过本设定时，是否将标题自动缩减到本设定中的字节数，0 为不自动缩减',
