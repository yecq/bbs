...
<p>Between Hong Sing if you and any dispute or controversy, should first be settled through friendly consultations, the consultation fails, you hereby agree to submit the dispute or controversy Sing Haidian District People\'s Court where jurisdiction. Hong Sing Company has the right to interpret the above terms and discretion.</p>
	...
	'max_size'		=> 'Wspiera / maksymalny rozmiar',//'支持/最大尺寸',
	'project'		=> 'Projekt',//'项目',
	...
	'method_undefined'		=> 'Niezdefiniowana metoda',//'未定义方法',
	'database_nonexistence'		=> 'Obiekt bazy danych nie istnieje',//'数据库操作对象不存在',
	'skip_current'			=> 'Pomiń ten krok',//'跳过本步',
	'topic'				=> 'Temat',//'专题',
	'install_finish'		=> 'Instalacja zakończona sukcesem. Kliknij tutaj, aby odwiedzić Discuz X!',//'您的论坛已完成安装，点此访问',
...
//vot	'install_region_data'		=> 'Install regional data',//'Install regional data',
	...
	'mbstring'			=> 'Biblioteka MBstring',//'MBstring 库',
	'ext_info'			=> 'Dodatkowo, możesz zainstalować wiele ciekawych oraz użytecznych rozszerzeń i stylów dostępnych Centrum Aplikacji będącej w chmurze:',//'另外，你可以从云计算应用中心的许多有趣的和有用的插件和模板安装：',//'另外，你可以從雲計算應用中心的許多有趣的和有用的插件和模板安裝：',
//---------------------------------------------------------------
