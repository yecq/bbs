...
(
	...
	'file_upload_error_-101'	=> 'Przesyłanie nie powiodło się! Plik nie istnieje lub jest nieprawidłowy. Proszę powrócić.',//'上传失败！上传文件不存在或不合法，请返回。',
	'file_upload_error_-102'	=> 'Przesyłanie nie powiodło się! Plik nie jest obrazkiem. Proszę powrócić.',//'上传失败！非图片类型文件，请返回。',
	'file_upload_error_-103'	=> 'Przesyłanie nie powiodło się! Nie można zapisać pliku. Proszę powrócić.',//'上传失败！无法写入文件或写入失败，请返回。',
	'file_upload_error_-104'	=> 'Przesyłanie nie powiodło się! Nierozpoznany format pliku obrazu. Proszę powrócić.',//'上传失败！无法识别的图像文件格式，请返回。',
);
