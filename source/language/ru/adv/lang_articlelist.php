...
(
	...
	'articlelist_position_comment'	=> 'Есть 4 варианта размещения:',
	...
	'articlelist_category_comment'	=> 'Укажите категории портала для показа данной рекламы (для выбора нескольких категорий воспользуйтесь клавишами CTRL или SHIFT)',
);
