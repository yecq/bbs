...
$lang = array (
  ...
  'plugins_install_succeed' => 'ติดตั้งปลั๊กอินสำเร็จ!<br />ในการใช้ปลั๊กอินนี้, คุณอาจต้องทำการอัปโหลดเทมเพลทหรือไฟล์อื่นเพิ่มเติม, ดูเพิ่มเติมจากวิธีการติดตั้งของปลั๊กอิน<br /><br /><a href="http://addon.discuz.com?view=plugins">คลิกที่นี่เพื่อกลับไปที่ศูนย์แอพลิเคชัน</a><br />',
  ...
  'plugins_upgrade_succeed' => 'ปลั๊กอินได้รับการอัปเกรดเป็นเวอร์ชัน {toversion}<br /><br /><a href="http://addon.discuz.com?view=plugins">คลิกที่นี่เพื่อกลับไปที่ศูนย์ปลั๊กอิน</a><br />',
...
/*3.2*/	'two_domain_have_been_occupied'	=> 'Sorry, this subdomain name has been occupied',//'抱歉，二级域名已被占用',
  ...
  'magics_parameter_invalid' => 'พารามิเตอร์ไอเท็มไม่ถูกต้อง กรุณากลับไปปรับเปลี่ยนค่า',
	'magics_identifier_invalid'		=> 'Magic identificator is not unique (duplicated), please return to modify.',//'道具唯一标识重复，请返回修改。',
  ...
  'plugins_import_version_invalid_confirm' => 'ปลั๊กอินนี้สำหรับ Discuz! {cur_version} ซึ่งอาจเข้ากันไม่ได้กับเวอร์ชันปัจจุบัน({set_version}), คุณต้องการติดตั้งหรือไม่?<br />If this plug-in is not included in the installation instructions to modify the contents of the file then this plugin is a green plug-in, you can rest assured that the installation',
  'plugins_import_version_invalid' => 'ปลั๊กอินนี้สำหรับ Discuz! {cur_version} ซึ่งอาจเข้ากันไม่ได้กับเวอร์ชันปัจจุบัน({set_version})',
  'plugins_import_succeed' => 'นำเข้าข้อมูลปลั๊กอินสำเร็จ!<br />ในการใช้ปลั๊กอินนี้, คุณอาจต้องทำการอัปโหลดเทมเพลทหรือไฟล์อื่นเพิ่มเติม, ดูเพิ่มเติมจากวิธีการติดตั้งของปลั๊กอิน',
  'plugins_config_upgrade_confirm' => 'คุณแน่ใจว่าต้องการให้ {pluginname} {version} ถูกอัปเกรดไปยังเวอร์ชัน {toversion} ?',
  ...
  'plugins_setting_module_nonexistence' => 'ไฟล์โมดูลปลั๊กอินที่ระบุ({modfile})ไม่มีอยู่จริงหรือการลำดับโค้ดผิดรูปแบบ, โปรดแน่ใจว่าการอัปโหลดปลั๊กอินสมบูรณ์จริง',
  ...
  'cloudaddons_check_url_fopen_error' => 'เซิร์ฟเวอร์ของคุณไม่สามารถเข้าถึงคลังแอพลิเคชัน กรุณาติดต่อผู้ให้บริการโฮสต์ของคุณหรือทีมงานฝ่ายเทคนิค เพื่อให้สามารถเข้าถึง addon.discuz.com หรือ addon1.discuz.com ได้',
