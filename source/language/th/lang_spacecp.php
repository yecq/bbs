...
$lang = array(
	...
	'share_comment' => '<a href="\\2" target="_blank">\\1 แสดงความคิดเห็นเกี่ยวกับการแชร์ของคุณ</a>',
	'friend_pm' => '<a href="\\2" target="_blank">\\1 ส่งข้อความส่วนตัวถึงคุณ</a>',
	'poke_subject' => '<a href="\\2" target="_blank">\\1 ส่งการสะกิดถึงคุณ</a>',
	...
	'space_update' => '{actor} อัปเดตโปรไฟล์ส่วนตัว',
	...
	'share_space' => 'แชร์โปรไฟล์',
	'share_blog' => 'แชร์บล็อก',
	...
	'share_link' => 'แชร์เว็บไซต์',
	'share_video' => 'แชร์วีดีโอ',
	'share_music' => 'แชร์เพลง',
	'share_flash' => 'แชร์แฟลช Flash',
	'share_event' => 'แชร์กิจกรรม',
	'share_poll' => 'แชร์โพล \\1',
	'event_time' => 'เวลา',
	...
	'not_allow_upload' => 'คุณไม่ได้รับอนุญาตให้อัปโหลดรูปภาพ',
	...
	'lack_of_access_to_upload_file_size' => 'ไม่สามารถอัปโหลด เนื่องจากพื้นที่โปรไฟล์ของคุณเต็ม',
	'only_allows_upload_file_types' => 'ไฟล์รูปภาพจะต้องเป็นรูปแบบ jpg, jpeg, gif, png เท่านั้น',
	'unable_to_create_upload_directory_server' => 'ไม่สามารถสร้างโฟลเดอร์สำหรับเก็บไฟล์ที่อัปโหลดบนเซิร์ฟเวอร์ได้',
	'inadequate_capacity_space' => 'ความจุของพื้นที่ไม่เพียงพอ ไม่สามารถอัปโหลดไฟล์ใหม่',
	'mobile_picture_temporary_failure' => 'ไม่สามารถย้ายไฟล์ที่ระบุไปยังไปยังโฟลเดอร์ชั่วคราวบนเซิร์ฟเวอร์ได้',
	'ftp_upload_file_size' => 'อัปโหลดรูปภาพระยะไกลล้มเหลว',
	'comment' => 'แสดงความคิดเห็น',
	'upload_a_new_picture' => 'อัปโหลดรูปภาพใหม่',
	'upload_album' => 'อัลบั้มอัปเดตล่าสุด',
	'the_total_picture' => 'ทั้งหมด \\1 รูปภาพ',

	'space_open_subject' => 'แจ้งเตือน ให้ดูแลและอัปเดตโปรไฟล์ส่วนตัวของคุณ',
	'space_open_message' => 'สวัสดี วันนี้ฉันได้ไปเยี่ยมชมโปรไฟล์ส่วนตัวของคุณ พบว่าคุณไม่ดูแลโปรไฟล์ของตัวเอง คุณน่าจะไปดูแลและอัปเดตโปรไฟล์ของคุณบ้าง โปรไฟล์ของคุณคือ:\\1space.php',
