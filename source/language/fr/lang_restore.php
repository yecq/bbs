...
//utility/restore.php
	...
	'tableprediff'		=> 'Pr&#233;fixe de Table($_config[\'db\'][\'1\'][\'tablepre\'])',//' 表前缀($_config[\'db\'][\'1\'][\'tablepre\'])', // 'Table prefix ($_config[\'db\'][\'1\'][\'tablepre\'])'
	...
	'database_import_confirm_sql'		=> '&#201;tes-vous s&#251;r que vous voulez importer la sauvegarde?',//'您确定导入该备份吗？', // 'Are you sure you want to import the backup?' 
	'database_import_confirm_zip'		=> '&#201;tes-vous s&#251;r que vous voulez d&#233;compresser la sauvegarde?',//'您确定解压该备份吗？', // 'Are you sure you want to unzip the backup?'
...
// Added by Valery Votintsev
	'restore_title'		=> 'Discuz! outil de r&#233;cup&#233;ration de donn&#233;es',//'Discuz! 数据恢复工具', // 'Discuz! data recovery tool',
	'restore_questions'	=> 'Pour toutes questions de r&#233;cup&#233;ration, svp veuillez visiter le site de support',//'恢复当中有任何问题请访问技术支持站点',  // 'For any Recovering questions, please visit the support site',
	'browser_jump'		=> 'Navigateur passera automatiquement la page, sans intervention humaine. Sauf si longtemps lorsque votre navigateur ne supporte pas les cadres, cliquez ici',//'浏览器会自动跳转页面，无需人工干预。除非当您的浏览器长时间没有自动跳转时，请点击这里', // 'Browser will automatically jump page, without human intervention. Unless a long time when your browser does not support frames, please click here',
	'ok'			=> 'OK',//'确定', //
	'cancel'		=> 'Annuler',//'取消',  //'Cancel',
