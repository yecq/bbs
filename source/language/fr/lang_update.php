...
//	'sql_error'			=> ' Error. Please perform the following update statement by hand, then re-run the upgrade program',//'出错,请手工执行以下升级语句后,再重新运行本升级程序', // 
	...
	'real_name_progress'		=> 'Mise &#224; jour des vrais noms en progression:',//'实名功能升级中', // 'Real names upgrading progress:'
	...
	'plugin_center'			=> 'Discuz! Centre de(s) Module(s) ',//'Discuz! 扩展中心', // 'Discuz! Plugin Center'
	'plugin_forum'			=> 'Discuz! Forum Module',//'Discuz! 扩展中心最新的论坛插件', // 'Discuz! Plugin Forum'
	'settings_updated'		=> 'Configuration, r&#233;glages de la mise &#224; jour  est termin&#233;',//'配置项升级完成', // 'Configuration, Settings upgrade is completed'
	...
	'cache_update'			=> 'Cache mise &#224; jour, Svp. merci de patienter...',//'缓存更新中，请稍候 ...', // 'Cache update, please wait ...'
...
//-----------------------------------------------------------------------------
// Added in X2.5:
	'table_optimize'	=> 'Optimisation de la table',//'优化数据表',  //  'Optimize table', 
	'close_wait'		=> 'Votre site n&#180;est pas encore ferm&#233;, est en cours de fermeture, veuillez patienter...',//'您的站点未关闭，正在关闭，请稍后...',
	'length'		=> '[Longueur]',//'[时长]', // '[Length]',
	'status'		=> '[Statut]',//'[状态]', // '[Status]',
	'info'			=> '[Info]',//'[信息]',  //  '[Info]',
	'next_step_wait'	=> 'Pr&#234;t &#224; entrer dans l\'&#233;tape suivante, svp patienter...',//'准备进入下一步操作，请稍后...', //  
	'upgrade_wait'		=> 'Mis &#224; niveau, svp patienter...',//'正在升级数据，请稍后...', //  
//	'ready_to_db_upgrade'	=> 'Ready to enter the next step: upgrade the database structure',//'准备完毕，进入下一步数据库结构升级', //  
	'patches_dayly'		=> 'Correctifs de s&#233;curit&#233; en acc&#232;s quotidien',//'每日获取安全补丁', //  
	'regular_publish'	=> 'Sujets publi&#233;s réguli&#232;rement',//'定时发布主题', //  'Regular published topics', 
	'archive_weekly'	=> 'Archive de diffusion hebdomadaire',//'每周广播归档', //   'Weekly broadcast archive',
	'updates_daily'		=> 'Nombre de v&#233;rifications de mises &#224; jour quotidienne',//'更新每日查看数', //  'Number of daily update checks',
	'users_daily'		=> 'Optimisation quotidienne de la table Utilisateur',//'每日用户表优化', //  'Daily user table optimization', 
	'collection_follow'	=> 'Collection &#201;tat suivie (Taobao souscription de l\'album)',//'淘专辑被订阅', //  'Collection followed rule (Taobao album subscription)',
	'new_post'		=> 'New posts',//'新人帖','New posts',
	'moderated_completed'	=> 'Conversion de donn&#233;es mod&#233;r&#233;E est termin&#233;e',//'审核数据转换完毕', //  'Moderated data conversion is completed',
	'medal_completed'	=> 'Utilisateur de la M&#233;daille mise &#224; niveau des donn&#233;es est termin&#233;e',//'用户勋章数据升级完毕', //   'User Medal data upgrade is completed',
	'data_update_completed'	=> 'Mise &#224; jour des donn&#233;es termin&#233;',//'数据升级结束', //  'Data update is completed', 
	'group_stat_completed'	=> 'Forum Statistiques du Groupe mise &#224; niveau termin&#233;e',//'论坛版块统计数据升级完毕', //  'Forum Group statistics upgrade is completed',
//-----------------------------------------------------------------------------
// Added in X3.0:
	'cron_todayheats_daily'	=> 'Compteur actuel de posts Hots du jour',//'统计今日热帖', // 'Count today hot posts daily', 
	'hot_posts_completed'	=> 'Hot posts actualis&#233;s',//'热帖处理完毕', //  'Hot posts updated',
	'reminder_update_completed'	=> 'Rappel mise &#224; jour des donn&#233; es termin&#233;e',//'提醒数据升级完毕', //  'Remind data upgrade finished',
	'layout_update_completed'	=> 'Disposition des param&#232;tres de mise &#224; niveau termin&#233;e',//'布局方案设置升级完毕', // 'Layout settings upgrade finished', 
	'processed_from'	=> 'En cours de traitement partant de ',//'正在处理从 ', //  'Being processed from ',
	'starting_from'		=> ' partant de ',//' 开始 ', //  ' starting from ',
	'popular_posts'		=> 'posts populaires',//'的热帖', //  'popular posts',
//To lang_template:
	'default_layout'	=> 'Disposition par d&#233;faut',//'默认方案', //  'Default layout', // OU Mise en page par défaut
	'qq_bbcode_description'	=> 'Statut en ligne QQ, ic&#244;ne de points et son/sa discussion T-chat',//'显示 QQ 在线状态，点这个图标可以和他（她）聊天', //  'QQ online status, points icon and his/her chat',
	'qq_enter'		=> 'Svp.Veuillez entrer le No.QQ',//'请输入 QQ 号码', //  'Please enter the QQ number',
	'qq_onlne_status'	=> 'D&#233;finir QQ statut en ligne',//'设置QQ在线状态',  //   'Set QQ online status',
	'open_soso'		=> '<br><br>Conseils:<br>Afin de réduire le forum au chargement, cette mise à jour va vous aider à utiliser notre site web service de recherche géo-localisation.<br>Vous pouvez y aller',//'<br><br>友情提示：<br>为更好的降低论坛搜索时的数据压力，本次升级已经帮本站开通纵横搜索服务。<br>你可以在',  //  '<br><br>Tips:<br>In order to reduce the forum loading, this upgrade will help you to use our website Geo-location search service.<br>You can go to',
	'open_soso_link'	=> 'AdminCP -&gt; Plateforme Nuage Cloud -&gt; G&#233;o-localisation Gestion de la recherche',//'站点后台-&gt;云平台-&gt;纵横搜索 进行管理',  //  'AdminCP -&gt; Cloud platform -&gt; Geo-location search Management',
